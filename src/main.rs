...
extern {
      ...
      pub fn epoll_ctl(epfd: c_int, op: u32, fd: i32, event: *const EpollEvent) -> i32;
      pub fn epoll_wait(epfd: libc::c_int, events:*const EpollEvent, maxevents: libc::c_int, timeout: libc::c_int) -> libc::c_int;     
  }
...
// }
{  let tx=tx.clone();
eventloop_add(Bikes{num:21,name:"ROYAL - ENFEILD"},tx,3); 
}
